...
const char* ssid = "Poco F3";      // Ganti dengan SSID WiFi Anda
const char* password = "hallokak";   // Ganti dengan password WiFi Anda
...
const char* myWriteAPIKey = "UGXB57Q9X9LYZLY6";  // Ganti dengan API Key ThingSpeak Anda
